...
public class ClientResources {
    ...
    private final AuthorizationCodeResourceDetails client = new AuthorizationCodeResourceDetails(); // application.yml에 있는 spring.security.ex.client 하위 key-value 값 매핑
